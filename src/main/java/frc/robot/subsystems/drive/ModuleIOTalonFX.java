...
public class ModuleIOTalonFX implements ModuleIO {
  ...
  public ModuleIOTalonFX(
    ...
    turnConfig.CurrentLimits.StatorCurrentLimit = 20;
    ...
    // With an offset of CANcoderOffset and inverted if needed
    customEncoder.setInverted(constants.EncoderInverted);

    // Offset turn motor's relative encoder using ThriftyBot absolute encoder
    absEncoderAsDouble = (customEncoder.get() * 2 * Math.PI) + constants.EncoderOffset;
