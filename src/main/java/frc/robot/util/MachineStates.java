...
public class MachineStates {
  ...
  public static final BotState L2 = new BotState("L2", 0.19, 4.5, 0.5, 2);
  public static final BotState L3 = new BotState("L3", 0.14, 4.5, 0.41, 3);
  public static final BotState L4 = new BotState("L4", 0.13, 20, 0.52, 4); // 20.5
  public static final BotState INTAKE = new BotState("INTAKE", -0.164, -1.9, 0.15, 5); // 0
  ...
  public static final BotState INTAKEARM = new BotState("INTAKEARM", 0.05, 1, 0.09, 20);
