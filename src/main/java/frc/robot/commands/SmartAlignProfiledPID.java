...
public class SmartAlignProfiledPID extends Command {
  ...
  public void initialize() {
    ...
    m_profiledPidY = new TuneableProfiledPID("m_profiledPidY", 0.1, 0.0, 0.0, 5.0, 7.5);
    ...
    m_profiledPidX = new TuneableProfiledPID("m_profiledPidX", 0.05, 0.0, 0.0, 5.0, 3.0);
  ...
  public void execute() {
    ...
    if (LimelightHelpers.getTV(limelightName)) {
      ...
      yTrans = MathUtil.applyDeadband(yTrans, 0.05);
      xTrans = MathUtil.applyDeadband(xTrans, 0.05);
