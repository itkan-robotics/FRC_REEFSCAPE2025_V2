...
public class AutoBallPlusScoreCommand extends SequentialCommandGroup {
  Drive drive;
  ...
  StateMachine currState = new StateMachine();

  /** Creates a new AutoScoreCommand. */
  public AutoBallPlusScoreCommand(
      Drive d,
      ActuatorSubsystem a,
      ElevatorSubsystem e,
      ScoringSubsystem s,
    ...
    addCommands(
        ...
        // actuator.setGoal(20).withTimeout(0.5),
        // elevator.setGoal(38.5).withTimeout(0.5),
        // new AutoAlignTeleop(drive, lLimelight, storedState).withTimeout(0.5),
        ...
        elevator.setGoal(18.5).withTimeout(0.5),
        actuator.setGoal(25).withTimeout(0.5),
